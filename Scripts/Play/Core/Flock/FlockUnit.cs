...
public class FlockUnit : MonoBehaviour
{
    ...
    [SerializeField] public int fishindex;
    ...
    public void InitAnimFsm()
    {
        if (false == IsFsm)
            return;

        //등록
        AnimFSM.Regist_State(eAnimType.Swim, gameObject.AddComponent<AnimState_Swim>());
        AnimFSM.Regist_State(eAnimType.Eat, gameObject.AddComponent<AnimState_Eat>());
        AnimFSM.Regist_State(eAnimType.Cheer, gameObject.AddComponent<AnimState_Cheer>());

        //실행
        AnimFSM.Start_State(eAnimType.Swim);
    }

    public void AnimChangeState(eAnimType inType)
    {
        AnimFSM.Change_State(inType);
    }
